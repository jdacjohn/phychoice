...
function GS11() {
        window.open("hemo_PCT.html",'hemo PCT','toolbar=no,location=no,directories=no,status=yes,menubar=no,resizable=no,copyhistory=no,scrollbars=no,width=550,height=750');
}

function GS3() {
        window.open("admin_assist.html",'Administrative Assistant','toolbar=no,location=no,directories=no,status=yes,menubar=no,resizable=no,copyhistory=no,scrollbars=no,width=550,height=750');
}
...
<div class="jobdescriptions"><span>Job Opportunities Ohio</span>

	<ul>

	<li><a href="javascript:GS11()">Full Time Hemodialysis PCT - Choice One Renal Care of Newark, Ohio.</a></li>	
	</ul>
...
<tr><td valign="top"><img src="images/bullets.gif" width="12" height="13" alt="Bullets"></td>
<td><a href="facilities_ohio.asp">Ohio Facilities</a></td></tr>
